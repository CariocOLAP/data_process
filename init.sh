...
echo "#################################Stage Trajeto#################################"
sh kettle/kitchen.sh -file="../ktrs/datario/0_prepare_routes/prepare_routes.kjb" -param:DATABASE_NAME=$DATABASE_NAME -param:PASSWORD=$PASSWORD -param:PORT_NUMBER=$PORT_NUMBER -param:USERNAME=$USERNAME -param:HOSTNAME=$HOSTNAME
